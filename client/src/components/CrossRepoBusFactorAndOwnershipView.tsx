...
import { getCrossRepoBusFactorAndOwnership, type CrossRepoBusFactorAndOwnership as CrossRepoBusFactorAndOwnershipType } from '../api';
    ...
    <>
      ...
      {loading && !analytics ? (
        ...
        <div className="text-center py-12 text-gray-500">
          No project selected. Select a project to view cross-repo bus factor and ownership analytics.
        </div>
      )}
    </>
  );
