        ...
        <div className="space-y-6">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
              Network of authors who have collaborated on the same files. Nodes represent authors,
              edges represent shared file modifications.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-white">
                {collaborationGraph.nodes.length}
              </p>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
              <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-white">
                {collaborationGraph.edges.length}
              </p>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4">
              <h3 className="text-sm font-medium text-gray-600 dark:text-gray-400 mb-1">
              ...
              <p className="text-2xl font-bold text-gray-900 dark:text-white">
                {collaborationGraph.clusters?.length || 0}
              </p>
            </div>
          </div>
      ...
      {selectedSection === 'silos' && (
        <div className="space-y-6">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
              Files or components only touched by 1-2 people, indicating potential knowledge silos
              and bus factor risk.
            </p>
          </div>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
            <h3 className="text-lg font-medium text-gray-900 dark:text-white mb-4">
              Files with Limited Contributors
            </h3>
                  ...
                  >
                    <div className="flex items-start justify-between mb-2">
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-gray-600 dark:text-gray-400">
                          {silo.authorCount} contributor{silo.authorCount !== 1 ? 's' : ''}:{' '}
                          {silo.authors.join(', ')}
                        </div>
                      </div>
      ...
      {selectedSection === 'orphaned' && (
        <div className="space-y-6">
          <div>
            ...
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
              Files that haven't been touched in 2+ years, indicating potentially dead or deprecated
              code.
            </p>
          </div>
                  ...
                  >
                    <div className="flex items-start justify-between mb-2">
                      <div className="flex-1">
                        ...
                        <div className="text-sm text-gray-600 dark:text-gray-400">
                          Last modified by {orphan.lastAuthor} ({orphan.daysSinceLastCommit} days
                          ago)
                        </div>
                      </div>
                      <div className="text-right text-sm text-gray-500 dark:text-gray-400">
                        ...
                        <div className="text-xs">
                          {new Date(orphan.lastCommitDate).toLocaleDateString()}
                        </div>
                      </div>
                    </div>
                  </div>
